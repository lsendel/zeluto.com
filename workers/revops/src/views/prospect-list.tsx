...
const RecommendationBadge: FC<{ recommendation: string }> = ({
  recommendation,
}) => {
  ...
  return (
    <span
      class={`inline-flex items-center rounded-full px-2 py-0.5 text-xs font-medium ${colors[recommendation] ?? 'bg-gray-100 text-gray-800'}`}
    >
