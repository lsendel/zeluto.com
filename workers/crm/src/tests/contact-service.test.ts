...
const mockRepo: ContactRepository = {
    ...
    findBySegment: vi.fn().mockResolvedValue({ data: [], total: 0, nextOffset: null }),
    save: vi.fn(),
    saveMany: vi.fn(),
    delete: vi.fn(),
...
describe('ContactService', () => {
    ...
    describe('create', () => {
        ...
        it('should fail if email already exists', async () => {
            ...
            vi.mocked(mockRepo.findByEmail).mockResolvedValue({ id: 'existing' } as any);
...
const result = await service.update(orgId, contactId, { firstName: 'Jane' });
        ...
        it('should fail if contact not found', async () => {
            ...
            const result = await service.update('org-id', 'missing-id', { firstName: 'Jane' });
    ...
    describe('delete', () => {
        it('should delete a contact', async () => {
            ...
            const existingContact = Contact.create({ organizationId: orgId, email: 'del@example.com' });
