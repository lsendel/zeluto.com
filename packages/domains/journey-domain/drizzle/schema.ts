...
export const journey_versions = journeySchema.table('journey_versions', {
  id: uuid('id').primaryKey().defaultRandom(),
...
export const journey_step_connections = journeySchema.table('journey_step_connections', {
  id: uuid('id').primaryKey().defaultRandom(),
...
export const journey_executions = journeySchema.table('journey_executions', {
  id: uuid('id').primaryKey().defaultRandom(),
  journey_id: uuid('journey_id').notNull(),
  journey_version_id: uuid('journey_version_id').notNull(),
  organization_id: uuid('organization_id').notNull(),
...
export const step_executions = journeySchema.table('step_executions', {
  id: uuid('id').primaryKey().defaultRandom(),
...
export const execution_logs = journeySchema.table('execution_logs', {
  id: uuid('id').primaryKey().defaultRandom(),
  execution_id: uuid('execution_id').notNull(),
  organization_id: uuid('organization_id').notNull(),
