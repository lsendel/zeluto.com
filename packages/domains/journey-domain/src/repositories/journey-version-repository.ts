...
export interface JourneyVersionRepository {
  findById(orgId: OrganizationId, id: JourneyVersionId): Promise<JourneyVersion | null>;
  findLatestByJourney(
    orgId: OrganizationId,
    journeyId: JourneyId,
  ): Promise<JourneyVersion | null>;
  findByJourney(orgId: OrganizationId, journeyId: JourneyId): Promise<JourneyVersion[]>;
