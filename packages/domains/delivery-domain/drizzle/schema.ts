...
export const delivery_jobs = deliverySchema.table('delivery_jobs', {
...
export const delivery_events = deliverySchema.table('delivery_events', {
  id: uuid('id').primaryKey().defaultRandom(),
...
export const provider_configs = deliverySchema.table('provider_configs', {
  id: uuid('id').primaryKey().defaultRandom(),
  organization_id: uuid('organization_id').notNull(),
  channel: varchar('channel', { length: 50 }).notNull(),
...
export const suppressions = deliverySchema.table('suppressions', {
  id: uuid('id').primaryKey().defaultRandom(),
  organization_id: uuid('organization_id').notNull(),
...
export const sending_domains = deliverySchema.table('sending_domains', {
  id: uuid('id').primaryKey().defaultRandom(),
  organization_id: uuid('organization_id').notNull(),
