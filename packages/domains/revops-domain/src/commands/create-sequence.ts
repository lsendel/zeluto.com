...
export const CreateSequenceCommandSchema = z.object({
  ...
  steps: z.array(z.object({
    type: z.enum(['email', 'linkedin_connect', 'linkedin_message', 'sms', 'phone_call', 'wait']),
...
export function createSequenceCommand(input: CreateSequenceCommand): CreateSequenceCommand {
